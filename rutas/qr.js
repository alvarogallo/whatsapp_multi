...
router.get('/qr/:codigo', async (req, res) => {
  ...
  router.post('/reiniciar/:codigo', async (req, res) => {
    try {
      ...
      await clients[codigo].client.destroy();
      ...
      console.error(`[POST /reiniciar/${req.params.codigo}] Error:`, err);
